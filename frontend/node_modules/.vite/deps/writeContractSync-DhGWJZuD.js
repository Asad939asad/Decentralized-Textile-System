...
async function recoverPublicKey$1({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-drXxl83x.js").then((n) => n.n);
	return `0x${(() => {
...
//# sourceMappingURL=writeContractSync-DhGWJZuD.js.map